...
confirmation and application. Review batches are stable persisted pages that
preserve complete source clusters, so matching, fuzzy disclosures, and command
source-ID validation never widen to an adjacent batch.
